...
//Code Here
let evenNumbers = mixedNumbers.filter(function(ele){
  return ele % 2=== 0
})
...
//Code Here
let totalPopulation = populations.reduce(function(acc, ele) {
    return acc + ele
})
...
let bobsTotal = purchases.reduce(function(acc, ele){
  if(ele.owner === 'Bob') {
